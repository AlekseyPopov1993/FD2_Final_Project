...
// const touchAudio= new Audio("http://ricostardeluxe.free.fr/PUNCH1.wav")
...
//     if ((ball.posY - ball.radius <= areaH.floor) || (ball.posY + ball.radius >= areaH.height)) {
...
//     newPoint.style.cssText += "text-align: center";
//     newPoint.style.cssText += `margin: -400px auto 0 auto`;
...
//     goal.style.cssText += "object-fit: cover";
//     goal.style.cssText += "position: absolute";
...
//     congrats.style.cssText += `margin: -500px auto 0 auto`;
...
//     congratsText.style.cssText += "text-align:center";
...
//     congratsImg.style.cssText += `max-width: ${canvasWidth/4}px`;
//     congratsImg.style.cssText += "object-fit: cover";
...
//     // window.addEventListener('popstate', backGame)
...
//         document.removeEventListener ('keydown', stopEsc);
//         // window.removeEventListener('popstate', backGame);
//     });
...
(function () {
    ...
    function Model() {
        ...
        this.startAnimation = function () {
            let timer = requestAnimationFrame(myView.drawFieldAndPlayers);
        }
    }
     ...
     function View () {
        ...
        this.init = function(container) {
          myField = container;
            ...
            this.drawFieldAndPlayers();
        }

        this.createComponents = function () {
            gamePage.style.cssText += "max-width: 1280px";
            gamePage.style.cssText += "margin: 0 auto";
            gamePage.style.cssText += "position: relative";

            // создаём табло:

            scoreboard.setAttribute("id", "scoreboard");
            scoreboard.style.cssText += `height: ${scoreboardHeight}px`;
            scoreboard.style.cssText += "background-color: silver";
            scoreboard.style.cssText += "display: flex";
            scoreboard.style.cssText += "flex-direction: row";
            scoreboard.style.cssText += "justify-content: space-around";
            scoreboard.style.cssText += "align-items: center";
            scoreboard.style.cssText += "text-align: center";
            ...
            leftPlayerName.style.cssText += "color: blue";
            leftPlayerName.style.cssText += "font-size: 24px";
            leftPlayerName.style.cssText += "margin: 10px";
            leftPlayerCount.style.cssText += "font-size: 40px";
            leftPlayerCount.style.cssText += "margin: 0";
            leftPlayerCount.style.cssText += "color: blue";

            // ... кнопку паузы и строчки, информирующую игроков, до скольки очков ведётся игра, ...
            ...
            rightPlayerName.style.cssText += "color: red";
            rightPlayerName.style.cssText += "font-size: 24px";
            rightPlayerName.style.cssText += "margin: 10px";
            rightPlayerCount.style.cssText += "font-size: 40px";
            rightPlayerCount.style.cssText += "margin: 0";
            rightPlayerCount.style.cssText += "color: red";
                
            //  Создание полотна канвас

            canvas.setAttribute("id", "canvas");
            canvas.style.cssText += "max-width: 1280px";
            gamePage.append(canvas);

            // Создание блоков с анимированными игроками: 

            PlayerLeft.classList.add('left-player');
            PlayerLeft.style.cssText += "position: absolute";
            PlayerLeft.style.cssText += `background-size: cover`;
            gamePage.append(PlayerLeft);

            PlayerRight.classList.add('right-player');
            PlayerRight.style.cssText += "position: absolute";
            PlayerRight.style.cssText += `background-size: cover`;
            gamePage.append(PlayerRight);
        }

        this.drawFieldAndPlayers = function () {
        ...
        timer = requestAnimationFrame(this.drawFieldAndPlayers);    
    }
    ...
    GameController.init(GameModel, GameContainer);
})();
